...
-- AddForeignKey
ALTER TABLE "luggage_delivery_order" ADD CONSTRAINT "luggage_delivery_order_organization_id_fkey" FOREIGN KEY ("organization_id") REFERENCES "organization"("id") ON DELETE NO ACTION ON UPDATE NO ACTION;
