...
import { getLuggageDeliveryOrderById } from 'apiSdk/luggage-delivery-orders';
...
function LuggageDeliveryOrderViewPage() {
      ...
      <Box bg="white" p={4} rounded="md" shadow="md">
        <Flex justifyContent="space-between" mb={4}>
          <Text as="h1" fontSize="2xl" fontWeight="bold">
            Luggage Delivery Order Detail View
          </Text>
          {hasAccess('luggage_delivery_order', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
            <NextLink href={`/luggage-delivery-orders/edit/${data?.id}`} passHref legacyBehavior>
              <Button
