    ...
    <AppLayout>
      <Box bg="white" p={4} rounded="md" shadow="md">
        ...
        <form onSubmit={formik.handleSubmit}>
          <FormControl id="order_details" mb="4" isInvalid={!!formik.errors?.order_details}>
            ...
            />
            {formik.errors.order_details && <FormErrorMessage>{formik.errors?.order_details}</FormErrorMessage>}
          </FormControl>
